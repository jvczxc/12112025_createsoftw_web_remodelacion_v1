...
class ModeloControlador{
    ...
    static function dominio_y_hosting(){
        $producto = new Modelo();
        $dato1 = $producto->mostrar('cs_products', 'id = 11');/* Se definen variables $tabla, $condicion */
        $dato2 = $producto->mostrar('cs_products', 'id = 13');/* Se definen variables $tabla, $condicion */
        $dato3 = $producto->mostrar('cs_products', 'id = 27');/* Se definen variables $tabla, $condicion */
        $dato4 = $producto->mostrar('cs_products', 'id = 28');/* Se definen variables $tabla, $condicion */
        require_once 'view/dominio_y_hosting.php';    
    }
    ...
    static function vps(){                      
        $producto = new Modelo();
        $dato1 = $producto->mostrar('cs_products', 'id = 24');/* Se definen variables $tabla, $condicion */
        $dato2 = $producto->mostrar('cs_products', 'id = 25');/* Se definen variables $tabla, $condicion */
        $dato3 = $producto->mostrar('cs_products', 'id = 26');/* Se definen variables $tabla, $condicion */
        require_once 'view/vps.php';    
    }
